...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 17 2013 г., 19:04
...
(1, 'Рубль', 'RUB', '', ' р.', '2', 32.08800125, 1, '2013-10-16 19:46:52'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2013-10-17 18:41:18'),
(3, 'Euro', 'EUR', '', '€', '2', 0.73909998, 1, '2013-10-16 19:46:52');
...
(135, 0, 'config', 'config_encryption', '212f5377593c6e54b867f849f5582a9e', 0),
...
(133, 0, 'config', 'config_email', 'admin@mail.ru', 0),
...
(134, 0, 'config', 'config_url', 'http://localhost/voronina-store/', 0);
